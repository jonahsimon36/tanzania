...
base10 <- select(children2010, caseid, midx, v001, v007, v024, v025, v113, v115, v116, v119, v127, v128, v129, v137, v190, ml0, h22)
base10$v115 <- ifelse(base10$v115 == 996, 0, ifelse(base10$v115 == 997 | base10$v115 == 999,NA,base10$v115))
...
# construct base15
# investigate v115, v161, ml10, v717

base15 <- select(children2015, caseid, midx, v001, v007, v012, v024, v025, v113, v115, v116, v119, v127, v128, v129, v136, v137, v149, v152, v161, v190, ml0, v201, v218, v717, b8, h22)
base15$v115 <- ifelse(base15$v115 == 996, 0, ifelse(base15$v115 == 997 | base15$v115 == 999,NA,base15$v115))
